...
CREATE UNIQUE INDEX uq_local_runner_node_runner_id
    ON tb_local_runner_node (runner_id);

CREATE INDEX idx_local_runner_node_install_id
...
CREATE UNIQUE INDEX uq_local_runner_task_run_id
    ON tb_local_runner_task (run_id);

CREATE INDEX idx_local_runner_task_runner_status
    ON tb_local_runner_task (runner_id, status, priority, created_at);

CREATE INDEX idx_local_runner_task_workspace
...
CREATE UNIQUE INDEX uq_local_runner_task_log_sequence
    ON tb_local_runner_task_log (run_id, sequence_no);

CREATE INDEX idx_local_runner_task_log_run
