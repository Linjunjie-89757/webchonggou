...
CREATE INDEX IF NOT EXISTS idx_bug_case_relation_bug_id ON tb_bug_case_relation (bug_id);
CREATE INDEX IF NOT EXISTS idx_bug_case_relation_case_id ON tb_bug_case_relation (case_id);
