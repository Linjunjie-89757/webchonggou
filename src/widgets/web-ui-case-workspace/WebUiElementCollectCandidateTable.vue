  ...
  >
    ...
    <el-table-column label="来源" width="118">
      <template #default="{ row }">
        ...
        <el-tag v-if="isAiMetadataEnhanced(row)" type="success" effect="light" class="web-ui-collect-candidate-table__source-tag">
          AI 增强
        </el-tag>
        <small v-if="row.saveBlockedReason" class="web-ui-collect-candidate-table__hint">
    ...
    <el-table-column label="建议分组" min-width="140">
      <template #default="{ row }">
        <el-input v-model="row.groupName" maxlength="80" />
      </template>
    </el-table-column>
    <el-table-column label="元素名称" min-width="160">
      <template #default="{ row }">
    ...
    <el-table-column label="推荐定位器" min-width="240">
      <template #default="{ row }">
        <el-input v-model="row.locatorValue" maxlength="1000" />
      </template>
    </el-table-column>
    <el-table-column label="验证" min-width="160">
      <template #default="{ row }">
    ...
    <el-table-column label="业务含义" min-width="170" show-overflow-tooltip>
      <template #default="{ row }">
...
.web-ui-collect-candidate-table__source-tag,
